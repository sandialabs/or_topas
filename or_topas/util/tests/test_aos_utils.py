...
class TestNumpyUtilsUnit(unittest.TestCase):
    ...
    def test_random_direction(self):
        ...
        vector = numpy_utils.get_random_direction(10)
        self.assertAlmostEqual(1.0, norm(vector))


class TestPyomoUtilsUnit(unittest.TestCase):
    ...
    def test_multiple_objectives(self):
        ...
        with self.assertRaisesRegex(RuntimeError, assert_text):
            pyomo_utils.get_active_objective(m)
    ...
    def test_one_objective(self):
        ...
        m.b1.o.deactivate()
        m.b2.o[0].deactivate()
        self.assertEqual(m.b2.o[1], pyomo_utils.get_active_objective(m))
    ...
    def test_min_rel_obj_constraint(self):
        ...
        m = self.get_simple_model()
        cons = pyomo_utils.add_objective_constraint(m, m.o, 2, 0.1, None)
    ...
    def test_min_abs_obj_constraint(self):
        ...
        m = self.get_simple_model()
        cons = pyomo_utils.add_objective_constraint(m, m.o, 2, None, 1)
        self.assertEqual(len(cons), 1)
        self.assertEqual(m.find_component("optimality_tol_rel"), None)
    ...
    def test_max_both_obj_constraint2(self):
        ...
        """
        m = self.get_simple_model(sense=pyo.maximize)
        cons = pyomo_utils.add_objective_constraint(m, m.o, 20, 0.5, 11)
